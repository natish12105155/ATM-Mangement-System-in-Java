...
public class ATM extends JFrame {
	...
	protected void buildApp(){
		...
		JLabel displayArea = new JLabel("<html>Instruction Area: <br> Please select a function from the buttons below <br> Current Balance: Rs" + balance + "</html>");
		...
		withDraw1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 500){
					balance = balance - 500;
					displayArea.setText("<html>Rs500 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn Rs500");
					updateTransactionHist("User Has Withdrawn Rs500");
				} else {
					displayArea.setText("<html> Your Balance is below Rs500. Unable to Withdraw!! <br><br>" 
		...
		withDraw2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 5000){
					...
					displayArea.setText("<html>Rs5000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn  Rs5000");
					updateTransactionHist("User Has Withdrawn Rs5000");
				} else {
					displayArea.setText("<html> Your Balance is below Rs5000. Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
		...
		withDraw3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 10000){
					...
					displayArea.setText("<html>Rs10000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn Rs10000");
					updateTransactionHist("User Has Withdrawn Rs10000");
				} else {
					displayArea.setText("<html> Your Balance is below Rs10000. Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
			}	
		});
		...
		deposit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
					displayArea.setText("<html> Deposit Selected! <br> Please input an amout below or equal to Rs and click enter! <br><br>" 
					+ finishedTransaction() + "</html>" );
					readyToEnter = true;
			}	
		});
			...
			public void actionPerformed(ActionEvent event) {
				if(readyToEnter == true){
					if(Integer.parseInt(getInputSequence()) > 10000){
						displayArea.setText("That input is greater than Rs!");
						clearInput();
						inputDisplay.setText("Input Display: ");
						readyToEnter = false;
						...
						displayArea.setText("<html> You have deposited Rs" + getInputSequence() 
						+ "! <br><br>" + finishedTransaction() + "</html>");
						System.out.println("User Has Deposited Rs" + getInputSequence());
						updateTransactionHist("User Has Deposited Rs" + getInputSequence());
					}
					clearInput();
					inputDisplay.setText("Input Display: ");
					readyToEnter = false;
	...
	String finishedTransaction(){
		return "Instruction Area: <br> Please select a function from the buttons below <br> Current Balance: Rs" + balance;
	}
